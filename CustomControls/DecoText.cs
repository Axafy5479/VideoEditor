...
namespace CustomControls
{
    ...
    /// </summary>
    public class DecoText : FrameworkElement
    {
        ...
        {
            if (Shadow && Stroke is SolidColorBrush solidStroke)
            {
                this.Effect = new DropShadowEffect() { Color = solidStroke.Color, Direction = -30 };
